...
require (
	...
	go.etcd.io/etcd/etcdctl/v3 v3.5.33 // indirect
	go.etcd.io/etcd/etcdutl/v3 v3.5.33 // indirect
	...
	go.etcd.io/etcd/tests/v3 v3.5.33 // indirect
	go.etcd.io/etcd/v3 v3.5.33 // indirect
